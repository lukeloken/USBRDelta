...
# YSIfilenames<-c('Channel Data depth Profiles February 28 2019.xlsx')
...
for (i in 1:length(YSIfilenames)){
  ...
  saveRDS(df_plot , file=paste0(dropbox_dir, '/Data/Rdata/YSIProfiles/VertialProfile_', Date, '.rds'))
