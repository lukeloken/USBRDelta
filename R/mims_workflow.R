...
write.csv(MIMS_outdf_Full, paste0(data_dir, "/Data/MIMS/Outputs/MIMScalculations_2018_08_2018.csv"))  #Save the file to your computer or dropbox.
...
png(paste0(data_dir, '/Figures/MIMS/2018August_MIMS_Boxplots.png'), width=5, height=8, units='in', res=200)
...
boxplot(MIMS_outdf_Full$narcalc~ MIMS_outdf_Full$SampleID, col=colors[2])
