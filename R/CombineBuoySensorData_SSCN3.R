...
DO_folder <-paste0(onedrive_dir, "/RawData/NutrientExperiment2/BuoyData/DO/9-4-2020_Download/DO_2020-09-04")
...
#Save to file
write.table(DO_df_clean, file=file.path(onedrive_dir, 'OutputData', 'NutrientExperiment2', 'Buoy', 'Buoy_DO_SSCN3_raw.csv'), row.names=F, sep=',')

saveRDS(DO_df_clean, file=file.path(onedrive_dir, 'RData', 'NutrientExperiment2', 'Buoy', 'Buoy_DO_SSCN3_raw.rds'))
