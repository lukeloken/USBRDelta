...
chem_metrics<-c("PO4_ppm", "TDP_ppm", "TP_ppm", "NH4_ppm", "NO3_ppm", "TDN_ppm", "TN_ppm", "DOC_ppm", "DIN_ppm", "DON_ppm", "TPN_ppm", "TSS", "VSS")
...
metrics <- c(flame_metrics, chem_metrics, gas_metrics)
