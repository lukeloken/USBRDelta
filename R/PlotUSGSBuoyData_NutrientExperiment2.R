...
png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/USGSBuoys/Huey_MetabPaper_SSCN2.png'), width=6, height=7, units='in', res=200)
...
#Important pieces from Huey
png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/USGSBuoys/Huey_MetabPaper_2Years.png'), width=7.5, height=6, units='in', res=200)

par(mar=c(1.5,4,0.5, 0.5), mgp=c(3,0.5,0), tck=-0.02, mfcol=c(4,2), oma=c(1.5,0,1.5,0), ps=10)
