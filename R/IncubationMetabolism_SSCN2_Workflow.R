...
directory_incubation<-paste(paste(box_dir,'Data/IncubationData/FormattedData', sep='/'))
...
for (file_nu in 1:length(files)){
  ...
  DOsd<-results[[2]]
    ...
    write.csv(DOrate_mean_long_table, file=paste0(google_dir, '/SSCN2_DataOutputs/IncubationMetabolism/IncubationMetabolism_', Date_ymd, '.csv'), row.names=F)
    saveRDS(DOrate_mean_long_table , file=paste0(dropbox_dir, '/Data/Rdata_SSCN2/IncubationMetabolism/IncubationMetabolism_', Date_ymd, '.rds'))
    ...
    png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/Incubations/MetabolismTimeseries_', Date_ymd, '.png'), width=8, height=12, units='in', res=200)
    ...
    png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/Incubations/MetabolismWithinSampleSD_', Date_ymd, '.png'), width=5, height=4, units='in', res=200)
    ...
    #Add legend to bottom of figure and save
    png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/Incubations/MetabolismBoxplot_', Date_ymd, '.png'), width=8, height=3, units='in', res=200)
    ...
    #Add legend to bottom of figure and save
    png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/Incubations/LightTreatments_Boxplot_', Date_ymd, '.png'), width=8, height=3, units='in', res=200)
    ...
    IncubationMetabolism_spread<-IncubationMetabolism_summary %>%
      select (Site, SampleDate, Metric, Treatment, MeanValue) %>%
    ...
    png(paste0(dropbox_dir, '/Figures/NutrientExperiment2/Incubations/GPP_ER_Scatter_', Date_ymd, '.png'), width=5, height=5, units='in', res=200)
