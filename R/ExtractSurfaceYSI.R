...
filenames<-list.files(paste0(dropbox_dir, "/Data/YSIVerticalProfiles"))

filename<-filenames[1]
directory<-paste0(dropbox_dir, "/Data/YSIVerticalProfiles")
...
biglist<-lapply(filenames, extract_surface, directory=paste0(dropbox_dir, "/Data/YSIVerticalProfiles"))
